...
post_install() {
    ...
    echo "  greppy login              # Setup AI (Ollama local or cloud)"
    ...
    echo "  greppy trace --refs <sym> -c2 # Find references with context"
    ...
    echo ""
    echo -e "${BLUE}AI model management:${NC}"
    echo "  greppy model              # Switch AI models interactively"
    echo "  greppy login              # Add new AI provider"
